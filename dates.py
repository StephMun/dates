'''
    rhymes.py
    Estefania Munguia
    Purpose: This program reads in a file of dates and events and creates
    a dictionary object that stores multiple sate objects, holding a date
    and an event list. Depending on the file input, it either just stores
    the date objects into the dictionary object, or prints out the events
    for a specific date.
